#!/bin/bash
#BSUB -J task9                              # Job name
#BSUB -o out_and_err/task9%J.out
#BSUB -e out_and_err/task9%J.err
#BSUB -q c02613
#BSUB -n 4
...
for N in $(seq 10 2 20); do
    { time python task9.py $N ; } 2>> timing_results_task9.txt
    echo "N=$N" >> task9_timing_results.txt
done
